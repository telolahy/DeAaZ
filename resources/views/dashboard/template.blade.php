...
<head>
    ...
    <link href="{{asset('assets0/lib/tempusdominus/css/tempusdominus-bootstrap-4.min.css')}}" rel="stylesheet" />
...
<body>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                <a href="index.html" class="navbar-brand mx-4 mb-3">
                    <h5 class="text-primary"><i class="fa fa-user-edit me-2"></i>DeAaZ</h5>
                </a>
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        <img class="rounded-circle" src="{{Storage::url(Auth::user()->image)}}" alt="" style="width: 30px; height: 30px;">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{url("utilisateur")}}" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Utilisateurs & roles</a>
                    <a href="{{url("formateur")}}" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Formateurs</a>
                    <a href="{{url("cours")}}" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Cours</a>
                    <a href="{{url("etudiant")}}" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Etutiants</a>
                    ...
                    {{-- <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="{{url('error')}}" class="dropdown-item">404 Error</a>
                ...
                <div class="bg-secondary rounded-top p-4">
                    <div class="row">
                        <div class="col-12 col-sm-6 text-center text-sm-start">
                            &copy; <a href="#">Telolahy Daniel</a>, +26134 91 265 85. 
                        </div>
    ...
    <script src="{{asset('assets0/lib/chart/chart.min.js')}}"></script>
    ...
    <script src="{{asset('assets0/lib/tempusdominus/js/moment.min.js')}}"></script>
    <script src="{{asset('assets0/lib/tempusdominus/js/moment-timezone.min.js')}}"></script>
    <script src="{{asset('assets0/lib/tempusdominus/js/tempusdominus-bootstrap-4.min.js')}}"></script>
